  ...
  if (compiler.hooks) {
    compiler.hooks.make.tapAsync(PLUGIN_NAME, function (compilation, cb) {
      ...
      HtmlWebpackPlugin
        ...
        .tapAsync(PLUGIN_NAME, function (data, callback) {
          for (var entryPoint of compilation.entrypoints.values()) {
            for (var chunk of entryPoint.chunks) {
      ...
      HtmlWebpackPlugin.getHooks(compilation).beforeEmit.tapAsync(PLUGIN_NAME, function (htmlPluginData, callback) {
        this$1.injectToHtml(htmlPluginData, skeletons, chunks);
 ...
 */
SkeletonPlugin.prototype.findSkeleton = function findSkeleton (htmlPluginData, skeletons, chunks) {
    if ( skeletons === void 0 ) skeletons = {};

  var usedChunks = htmlPluginData.plugin.userOptions.chunks || chunks;
 ...
 * @param {Object} skeletons skeletons
 */
SkeletonPlugin.prototype.injectToHtml = function injectToHtml (htmlPluginData, skeletons, chunks) {
    if ( skeletons === void 0 ) skeletons = {};

  var ref = this.options;
    var insertAfter = ref.insertAfter;
  var ref$1 = this.findSkeleton(htmlPluginData, skeletons, chunks);
    var name = ref$1.name;
