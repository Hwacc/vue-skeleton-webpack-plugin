 ...
 */
SkeletonPlugin.prototype.findSkeleton = function findSkeleton (skeletons, chunks) {
  ...
  if (Array.isArray(chunks)) {
    entryKey = Object.keys(skeletons).find(function (v) { return chunks.indexOf(v) > -1; });
  }
  else {
...
SkeletonPlugin.prototype.injectToHtml = function injectToHtml (htmlPluginData, skeletons, chunks) {
  ...
  var ref$1 = this.findSkeleton(skeletons, chunks);
    var name = ref$1.name;
